  ...
  return (
    <div>
      <div className="flex flex-col items-center mx-auto space-y-6 mt-32 px-10 sm:mt-52">
        <h1 className="text-5xl leading-10 tracking-tighter mb-4 font-bold  whitespace-break-spaces">
        ...
        <div className="flex space-x-2 text-primary-foreground relative">
          <div className="bg-primary border rounded-lg px-6 h-20 w-[20rem] md:w-[40rem] justify-center">
            <p placeholder="Auth gen" className="max-w-[15rem] my-6 break-before-all break-words text-xs sm:max-w-lg sm:my-8 md:max-w-[30rem]">{key}</p>
          </div>
